-- Inserting the first record to the account table
...
-- Select the make and model fields from the inventory table and the 
-- classification name field from the classification table for inventory items that 
...
-- file path in the inv_image and inv_thumbnail columns
UPDATE public.inventory
